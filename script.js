...
(function () {
  ...
  async function applyCropPdf() {
    ...
    try {
      for(const page of pages){ const size=page.getSize(); const w=Math.max(20,size.width-vals.left-vals.right), h=Math.max(20,size.height-vals.top-vals.bottom); page.setCropBox(vals.left,vals.bottom,w,h); }
