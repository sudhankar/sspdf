...
(function () {
  ...
  function initEventListeners() {
    ...
    const rotateLeftBtn = document.getElementById('btn-sidebar-rotate-left');
    ...
    if (rotateLeftBtn) rotateLeftBtn.addEventListener('click', () => rotateCurrentPage(-90));
  ...
  async function renderThumbnails() {
    ...
    for (let i = 1; i <= state.totalPages; i++) {
      ...
      thumbItem.addEventListener('click', () => {
        ...
        thumbItem.classList.add('selected'); renderPage(Number(thumbItem.dataset.page));
      });
    }
  ...
  async function duplicateCurrentPage(){
    ...
    try{
      ...
      state.currentPage=insertAt+1; await refreshPdfViewer(); saveStateToHistory(); showToast('Page duplicated','success');
