  ...
  async function applyCropPdf() {
    ...
    try {
      for(const page of pages){
        ...
        // CropBox is the correct PDF mechanism for visual cropping. Keeping the
        // MediaBox unchanged avoids shifting page coordinates/content.
        page.setCropBox(boxX+vals.left, boxY+vals.bottom, boxW-vals.left-vals.right, boxH-vals.top-vals.bottom);
      }
