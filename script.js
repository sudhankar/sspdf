...
(function () {
  ...
  async function renderThumbnails() {
    ...
    let dragEl = null, dragSourcePage = null, touchTimer = null, touchDragging = false;
  ...
  function addWatermark(){
    ...
    svg.appendChild(txt); el.appendChild(svg); DOM.overlayContainer.appendChild(el); makeElementDraggable(el); selectElement(el); addResizeHandle(el);
